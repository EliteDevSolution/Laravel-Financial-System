    ...
    <div id="contract">
        <div class="container">
            <div class="row text-center">
                <h1 class="d-inline-block mt-3 mb-1 text-capitalize main-heading">Contract # {{ $contract->id }}, {{ $contract->name }}</h1>
            </div>
            {{-- <div class="row">
            ...
            <div class="row mb-5">
                <div class="col-md-3" id="change-the-order">
                ...
                <div class="col-md-9 contract-box">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6" style="display: none;" id="confirmation-form">
                            ...
                            <div>
                                <form method="post" action="http://client.ksbin.com/c/u/s/{{ $user->id }}/{{ $contract->id }}" style="position: absolute;left: 33%;top:0">
                                    @csrf
                            ...
                            <div class="container">
                              <div class="row">
                                  ...
                                  <div id="container" class="contract-here p-0 m-0 border">
                                      ...
                                      <img src="{{ asset('storage/contracts/'.$contract->contract.'') }} " class="w-100">
                                  </div>
...
{{-- 
                      @else
                        ...
                        <img src="{{ asset('storage/signs/'.$contract->userSign.'') }}" alt="" width="300px"> --}}
